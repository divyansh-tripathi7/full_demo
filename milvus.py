...
#  create this into flask web app which works as main.py 
#  add async programming to combine all 3 topics into one 
#  dockerize all the work 
#  note docker containers cant access local data 
